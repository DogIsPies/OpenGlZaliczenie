...
public class ProstopadloscianLustrzaneOdbicie {
...
//					if((i+j)%2==0) gl.glColor3f(0.0f,0.0f,0.0f);
					gl.glBegin(GL2.GL_QUADS);
//					//front i tył
					gl.glTexCoord2f(0.5f,0.0f); gl.glVertex3f(-a/2+a*j/(n-1),-h/2+h*i/(p-1),b/2);
					...
					gl.glTexCoord2f(0.5f,1.0f); gl.glVertex3f(-a/2+a*j/(n-1),-h/2+h*(i+1)/(p-1),b/2);
